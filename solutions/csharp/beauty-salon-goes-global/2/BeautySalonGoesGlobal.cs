...
public static class Appointment
{
    ...
    public static Dictionary<Location, string> cultures = new Dictionary<Location, string>{
    ...
    public static bool HasDaylightSavingChanged(DateTime dt, Location location)
    {
        ...
        bool wasDst = tz.IsDaylightSavingTime(dt - oneWeek);
        return isDst ^ wasDst;
    ...
    {
        DateTime dt;
        CultureInfo culture = CultureInfo.CreateSpecificCulture(cultures[location]);
        if (DateTime.TryParse(dtStr, culture, out dt)) {
            return dt;
        } else {
